...
PHASE3_EVALUATOR_STATUS_ARTIFACT_DIR = BUILD_DIR / "phase3-evaluator-status"
...
SOURCE_PROMOTION_MANIFEST_PATH = DATA_DIR / "fixtures" / "source_promotion" / "ira_2022_source_promotion_manifest.json"
