...
Phase 3 implementation has started with approved schema, source, extraction-prompt, and privacy disabled-by-default promotion request evaluator slices. No candidate promotion execution is enabled.
...
Skipped future evaluator tests now name the required behavior for later fixture cases while schema, source, extraction-prompt, and privacy evaluator slices exist.
