...
Prompt-governance status: started with an approved prompt-template registry and adapter enforcement for approved provider, task, and source refs. Live providers require explicit template-level authorization; live-model agents remain deferred.
